...
2. **Testing:** Run `zig build test` before any commit to run the entire unit test suite (including sonar, learning, and sentinel tests) to ensure "Bio-Logic" stability.
